...
def can_split_pairs(card_one, card_two):
    ...
    if (card_one in face_cards and card_two in face_cards) or card_one == card_two:
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    total_two_card_value = [9, 10, 11]

    current_hand_value = value_of_card(card_one) + value_of_card(card_two)

    return current_hand_value in total_two_card_value